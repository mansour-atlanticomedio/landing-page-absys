...
function NewsCard({ new: { tag, title, description, image }, style }: { new: NewsProps, style: number }) {
        ...
        return (
            <article className="group relative h-80 overflow-hidden rounded-2xl bg-slate-900">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                    ...
                    <p className="mt-2 text-sm text-slate-200 opacity-0 transition-all duration-300 group-hover:opacity-100">{description}</p>
                </div>
            </article>
        );
    }
